...
//    printf("%d send dir name %s \n",getRank(),name);
    SendComputationName(name);
//    printf("%d received dir name %s \n",getRank(),name);
    strcpy(unique_variant_name,name);
...
//#pragma omp parallel for
    		for(int k = 0;k < grid_size_z;k++)
    		{
    		    			...
    		    			if(!strcmp(name,"WriteAllCurrents"))
    		    			{
    		    				char ftag[100];
	...
	#define GPU_PARTICLE
...

	  {
			...
			err = ferror(f);
		     ...
		     printf("SORT1 m %15.5e q_m %15.5e %10d (sum %10d) particles in %8d cells: MIN %10d MAX %10d average %10d \n",
...
//		     err = ferror(f);
		     ...
		     printf("SORT2 m %15.5e q_m %15.5e %10d (sum %10d) particles in %8d cells: MIN %10d MAX %10d average %10d \n",
		    		 m,            q_m,       total_particles,pn_sum,
		    		 (*AllCells).size(),
		    		 pn_min,pn_max,pn_ave);
//		     if((err = ferror(f)) != 0)
...
//	  }
	  ...
	  )
	  {
	     FILE *f;
         double *masses;
         printf("three sorts %d %d %d \n",total_ions,total_electrons,total_beam_electrons);
...
//		   printf("plasma_y_min %e plasma_y_max %e plasma_z_min %e plasma_z_max %e ",plasma_y_min,plasma_y_max,plasma_z_min,plasma_z_max);
...
//			  printf("y %e z %e plasma_y_min %e plasma_y_max %e plasma_z_min %e plasma_z_max %e %d %d %d %d \n",y,z,plasma_y_min,plasma_y_max,plasma_z_min,plasma_z_max,
//					  (plasma_y_min > y),(plasma_y_max < y),(plasma_z_min > z),(plasma_z_max < z)
//					  );
...
//         printf("NA %10d \n",N);
      ...
      {
//    	  printf("bMAxwell %d %d %d\n",initial[0].total,initial[1].total,initial[2].total);
...
///////////////////////////////////////////////////////////////////////
         if(beam_plasma == 1)
         {
//        	printf("InitBinaryParticles %d %d %d\n",initial[0].total,initial[1].total,initial[2].total);
